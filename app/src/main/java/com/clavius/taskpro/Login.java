...
public class Login extends AppCompatActivity {
        ...
        forgotPasswordTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (email.isEmpty()) {
                    ...
                    passwordResetHelper.resetPassword(email, Login.this);
                }
            }
        });
    ...
    private void login() {
        ...
        if (!isNetworkAvailable) {
            ...
            Toast.makeText(Login.this, "No internet connection. Please check your network settings.", Toast.LENGTH_LONG).show();
            return;
        }
    ...
    private class NetworkChangeReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (isNetworkAvailable()) {
                ...
                Toast.makeText(Login.this, "Network connection available", Toast.LENGTH_SHORT).show();
            } else {
                isNetworkAvailable = false;
                editTextEmail.setEnabled(false);
                editTextPassword.setEnabled(false);
                Toast.makeText(Login.this, "No internet connection. Please check your network settings.", Toast.LENGTH_SHORT).show();
            }
        }
    }
