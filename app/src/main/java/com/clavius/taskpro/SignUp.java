...
public class SignUp extends AppCompatActivity {
    ...
    private SignUp.NetworkChangeReceiver networkChangeReceiver;
...
//                handle login text click
        ...
        networkChangeReceiver = new SignUp.NetworkChangeReceiver();
    ...
    private void signUp() {
        ...
        if (!isNetworkAvailable) {
            ...
            Toast.makeText(SignUp.this, "No internet connection. Please check your network settings.", Toast.LENGTH_LONG).show();
            return;
        }
    ...
    private class NetworkChangeReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (isNetworkAvailable()) {
                ...
                Toast.makeText(SignUp.this, "Network connection available", Toast.LENGTH_SHORT).show();
            } else {
